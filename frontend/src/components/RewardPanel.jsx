  ...
  const contracts = useMemo(() => {
    ...
    return TOKENS.flatMap((token) => [
      ...
      },
      {
        ...
        args: [viewer, token.address, currentWeek],
      },
      {
        address: REWARD_DISTRIBUTOR,
        abi: rewardAbi,
  ...
  return (
    <section className="rewardPanelClean">
      <div className="rewardPanelHead">
        ...
        <button className="rewardRefreshButton" type="button" onClick={refreshAll}>
          Refresh
        </button>
      </div>
            ...
            return (
              <article className="rewardAssetCard" key={row.symbol}>
                ...
                <div className="rewardMetricGrid">
                  ...
                  <div className="rewardMetric">
                    <span>Threshold</span>
                    <strong>{fmt(row.threshold, row.decimals)}</strong>
                  </div>
                  <div className="rewardMetric">
                    <span>Reward balance</span>
                    <strong>{fmt(row.rewardBalance, row.decimals)}</strong>
                  </div>
                  <div className="rewardMetric">
                  ...
                  <div className="rewardMetric">
                    ...
                    <strong>{fmt(row.totalFunded, row.decimals)}</strong>
                  </div>
                  <div className="rewardMetric">
                    <span>Total claimed</span>
                    <strong>{fmt(row.totalClaimed, row.decimals)}</strong>
                  </div>
                </div>
      ...
      {isSuccess && <p className="rewardSuccess">Claim transaction confirmed.</p>}
